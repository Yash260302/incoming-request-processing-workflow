...
class PriorityPredictor:
    def __init__(self):
        self.model_path = Config.MODEL_DIR / "priority_model.pkl"
        self.vectorizer_path = Config.MODEL_DIR / "priority_vectorizer.pkl"
        self.encoder_path = Config.MODEL_DIR / "priority_encoder.pkl"
    ...
    def predict(self, text: str):
        ...
        priority = self.encoder.inverse_transform([prediction])[0]
